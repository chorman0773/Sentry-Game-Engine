...
import github.chorman0773.sentry.resources.Resource;
import github.chorman0773.sentry.resources.ResourceType;
...
public abstract class TextComponent {
	...
	public static class TranslatebleTextComponent extends TextComponent{
		...
		public TextComponent getAsFormatted() {
			return GameBasic.lang.translateAndFormat(this, new TextComponent[0]);
		}
		public TextComponent format(TextComponent[] args,int depth) {
			...
			return GameBasic.lang.translateAndFormat(this, nargs);
		}
		@Override
	...
	public static class GraphicTextComponent extends TextComponent{
		...
		protected Point drawOnComponent(Component comp, Point start, Font f, Color c) {
			...
			Resource r = GameBasic.currResourcePack.getResource(this.toUnformattedString(), ResourceType.GRAPHIC);
