 ...
 * the UUID given to the {@literal @Game} Annotation should be a Version 1, Variant 2 (Leach-Salz Definition), but
 * can legally be any UUID.
 * @author Connor
...
public abstract class GameBasic extends JPanel implements Runnable, Serializable, Thread.UncaughtExceptionHandler{	
	...
	/**
	 * Override Required method. When Extening GameBasic, you are required to add functionality for suspending the game, when the
